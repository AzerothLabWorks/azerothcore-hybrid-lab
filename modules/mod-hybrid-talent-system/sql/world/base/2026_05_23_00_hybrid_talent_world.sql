DROP TABLE IF EXISTS `hybrid_spell_template`;
CREATE TABLE `hybrid_spell_template` (
...
DROP TABLE IF EXISTS `hybrid_synergy_template`;
CREATE TABLE `hybrid_synergy_template` (
...
INSERT INTO `hybrid_spell_template`
