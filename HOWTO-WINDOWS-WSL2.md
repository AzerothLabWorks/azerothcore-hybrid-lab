...
6. Spawn the NPC in game.
   ...
   Quality-of-life tip: current versions also create item `1854`, `Hybrid Talent Beacon`, which is granted on login by default and summons a temporary trainer near you.
...
Current versions also create item `1912`, `Profession Master Beacon`, which is granted on login by default and summons a temporary Profession Master near you.
