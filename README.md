...
- **Multi-resource hybrid support**: QA server config can grant baseline mana, energy, and rage pools so cross-class builds can test abilities that depend on non-native class resources.
