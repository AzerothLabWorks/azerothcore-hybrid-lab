...
- **Class dependency packages**: Hybrid spells can grant supporting spells or items through config. Current packages include Drain Soul support for shard-based Warlock demon summons and Earth Totem item support for Strength of Earth Totem.
