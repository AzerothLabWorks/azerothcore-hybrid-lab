...
- **Selected Warrior stance relaxation**: Specific Warrior hybrid abilities have server-side stance requirements relaxed for cross-class play, including Charge, Intercept, Overpower, Mocking Blow, Revenge, Disarm, Shield Wall, Retaliation, Recklessness, Berserker Rage, Pummel, and Whirlwind. This is intentionally scoped and does not remove every stance, form, shapeshift, weapon, or class-resource requirement in the game.
